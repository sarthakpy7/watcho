...
function SideNav() {
  return (
    <div className='w-[25%] h-full p-4 border-r-2 border-zinc-700'>
        <h1 className='font-bold text-3xl tracking-tighter'> <i class="text-[#6556CC] ri-movie-2-line"></i> WATCHO</h1>
        ...
        <nav className='mt-5 px-2'>
            ...
            {[
                {icon :<i class="ri-information-2-fill"></i> ,title : 'About WATCHO', to :`/`},
